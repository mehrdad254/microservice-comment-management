...
public class Comment {
	...
	public Comment(Long id, String title, String subject, String createDateAt, String createTimeAt, String updateDateAt,
			String updateTimeAt) {
		super();
		this.id = id;
		this.title = title;
	...
	public String toString() {
		return "Comment [id=" + id + ", title=" + title + ", subject=" + subject + ", createDateAt=" + createDateAt
